...
Design documentation and the work backlog for brokering tool authentication to sandboxed coding agents live in the Security Token Service repository:
